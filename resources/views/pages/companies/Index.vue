...
<template layout="default">
    <div class="container-md mx-auto p-8 w-3/4">
        <div class="flex justify-between items-center mb-3">
            <h1 class="text-3xl font-semibold text-black">List of Companies</h1>
            <Link href="/companies/create" class="text-white rounded-lg border-2 border-solid bg-indigo-500 px-3 py-1">+ Add Company</Link>
        </div>
        <table class="w-full text-sm text-left text-gray 500">
            ...
            <tbody v-for="company of companies" :key="company.id">
                <tr class="bg-white border-b border-t">
                    ...
                    <td class="px-6 py-4">
                        <Link :href="'/companies/edit/' + company.id" class=""><i class="fa-solid fa-pen-to-square"></i></Link>
                    </td>
                </tr>
            </tbody>
        </table>
